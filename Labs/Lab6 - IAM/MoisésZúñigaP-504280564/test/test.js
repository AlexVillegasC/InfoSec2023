...
describe('unalib', function () {
    // Prueba la función 'is_valid_phone' de la librería propia 'unalib'
  ...
  // Prueba la función 'is_valid_url_image' de la librería 'unalib'
  ...
  // Prueba la función 'getYTVideoId' de la librería 'unalib'
  ...
  // Prueba la función 'is_valid_yt_video' la librería 'unalib'
