...
module.exports = {
    ...
    validateMessage: function(msg){
      ...
      if (this.containsScript(obj.mensaje)) {
        console.log("Alerta: Mensaje contiene script");
        return null; // Devuelve null para indicar que el mensaje está bloqueado.
      }
      return JSON.stringify(obj);

    },
    
    containsScript: function(text) {
